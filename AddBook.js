        ...
        <div className="container">
            ...
            <Form onSubmit={handleSubmit}>
                <Form.Group controlId="name">
                    ...
                    <Form.Control onBlur={handleOnBlur} type="text" placeholder="Enter Car Name" required/>
                </Form.Group>
                <Form.Group controlId="author">
                    <Form.Label>Car Model</Form.Label>
                    <Form.Control onBlur={handleOnBlur} type="text" placeholder="Enter Car Model" required/>
                </Form.Group>
                ...
                <Form.Group controlId="image">
                    <Form.File.Label>Car Image Upload</Form.File.Label>
